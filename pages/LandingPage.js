    ...
    return (
        <div>
            ...
            <Carousel/>
                ...
                <div key={products.id} className='grid grid-cols-1 gap-y-10 gap-x-4 mx-auto lg:grid-cols-4 '>
...
<button className='w-1/2 xl:w-full bg-black text-white py-2 mt-4 font-serif hover:bg-gray-600'> ADD TO CART</button>
